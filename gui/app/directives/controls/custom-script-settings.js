        ...
        .component("customScriptSettings", {
            ...
            <eos-container header="Script">
                ...
                <div class="effect-info alert alert-info">
                    Place scripts in the <a id="scriptFolderBtn" ng-click="openScriptsFolder()" style="text-decoration:underline;color:#53afff;cursor:pointer;">scripts folder</a> of the Twitchbot user-settings directory, then refresh the dropdown.
                </div>
            ...
            controller: function ($scope, utilityService, $rootScope, $q, logger,
                ...
                function loadParameters(scriptName, initialLoad = true) {
                    ...
                    try {
                        ...
                        if (!initialLoad && ($scope.scriptManifest == null || $scope.scriptManifest.twitcherbotVersion !== "5")) {
                            utilityService.showInfoModal("The selected script may not have been written for Twitchbot V5 and so might not function as expected. Please reach out to us on Discord or Twitter if you need assistance.");
                        }
