...
(function() {
    ...
    angular
        ...
        .factory("commandsServiceAutoReply", function(
            logger,
            connectionService,
            listenerService,
            backendCommunicator
            ...
            let getCommandsDb = () =>
                profileManager.getJsonDbInProfile("/chat/autoreply");
            ...
            service.refreshCommands = function() {
                ...
                if (cmdData.customCommands) {
                    logger.debug("loading custom autoreply: " + cmdData.customCommands);
            ...
            service.saveAllCustomCommands = (autoreply) => {
                service.commandsCache.customCommands = autoreply;
                const cleanedCommands = JSON.parse(angular.toJson(autoreply));
                try {
