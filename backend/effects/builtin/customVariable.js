...
const fileWriter = {
    ...
    optionsTemplate: `
        ...
        <eos-container header="Duration (Optional)" pad-top="true">
            <p class="muted">Duration (in seconds) this variable should be kept in the cache. Use 0 for indefinite (until Twitchbot restarts). </p>
