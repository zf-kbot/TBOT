   ...
   */
    ...
    <eos-container header="Show Duration" pad-top="true">
        ...
        <eos-collapsable-panel show-label="Advanced" hide-label="Hide Advanced">
            ...
            <p style="margin-bottom:10px">Optionally define which element(s) to be removed after the given duration via a CSS class as a selector. Leave blank to have Twitchbot always remove all the html above (Recommended).</p>
            <div class="input-group">
