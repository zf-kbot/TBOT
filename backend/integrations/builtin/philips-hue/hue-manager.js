...
async function deleteHueUser(hueUser) {
    // The hue api does not allow deleting users. So, this will just show a popup to the user on where to go to delete Twitchbot access.

    renderWindow.webContents.send(
        "error",
        "The Hue API does not allow Twitchbot to delete it's access from the hue bridge. Please visit https://account.meethue.com/apps and click deactivate on Twitchbot."
    );
}
