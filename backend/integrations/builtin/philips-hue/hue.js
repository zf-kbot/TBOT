...
const appName = 'Twitchbot';
const deviceName = 'Twitchbot-Hue';
...
class HueIntegration extends EventEmitter {
    ...
    async link() {
        ...
        renderWindow.webContents.send(
            "error",
            "Please press the link button on your hue bridge, then click the link button in Twitchbot."
        );
        throw new Error("Please press the link button on your hue bridge, then click the link button in Twitchbot.");
    }
