    ...
    optionsTemplate: `
        <eos-container header="Mode">
            <div class="controls-fb" style="padding-bottom: 5px;">
                ...
                <label class="control-fb control--radio">Custom game <tooltip text="'Input any name and Twitchbot will set the closest game it finds when effect is ran (useful with replace variables).'"></tooltip>
