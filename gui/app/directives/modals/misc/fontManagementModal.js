    ...
    angular
        ...
        .component("fontManagementModal", {
            ...
            <div class="modal-body">
                ...
                <div style="color: green;text-align: center;padding-top: 5px;" ng-if="$ctrl.installSuccessful">Font successfully installed! Please <strong>restart Twitchbot</strong> and <strong>refresh the overlay</strong> to put changes into effect.</div>
            </div>
