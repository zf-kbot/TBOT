...
(function () {
    angular.module("twitcherbotApp").component("setupWizardModal", {
        template: `
                ...
                <div ng-switch="$ctrl.getCurrentStep()" class="slide-frame">              
                    ...
                    <div ng-switch-when="1" class="wave">
                        <div ng-hide="$ctrl.importStarted || $ctrl.importCompleted" style="display:flex; flex-direction:column; justify-content: space-between;">
                            <div>
                                <div>
                                    <p>We have detected Twitchbot v4 data on your computer.<br><strong>Would you like to import anything?</strong></p>
                    ...
                    <div ng-switch-when="2" class="wave">
                        <p>
                            Twitchbot supports only one accounts:</br></br>
                    ...
                    <div ng-switch-when="3" class="wave">
                        ...
                        <p>The overlay is what allows Twitchbot to display images, videos, and more on your stream.</p>
                    ...
                    <div ng-switch-when="3" class="slide-fade">
                        ...
                        <p style="animation-delay: 1.8s" class="animated fadeIn">
                            <b>Thank you for using Twitchbot.</b>
                        </p>
        ...
        controller: function ($rootScope, connectionService, connectionManager,
            ...
            $ctrl.handleStart = async function (forceNext) {
                $ctrl.loginOrLogout('streamer');
                $ctrl.close();
            };
