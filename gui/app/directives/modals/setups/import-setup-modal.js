                ...
                <div class="modal-body">
                    <div ng-hide="$ctrl.setupSelected">
                        <file-chooser 
                            ...
                            options="{filters: [ {name:'Twitchbot Setups',extensions:['twitcherbotsetup']} ]}"
            ...
            controller: function ($q, logger, ngToast, commandsService, countersService, currencyService,
                ...
                $ctrl.popoutDescription = () => {
                    ...
                    modal.document.write(`
                        <div style="font-size: 30px;font-weight: 100;">Twitchbot Setup - ${$ctrl.setup.name}</div>
                        <div>${$ctrl.setup.description}</div>
                    `);

                    modal.document.title = `Twitchbot Setup - ${$ctrl.setup.name}`;
