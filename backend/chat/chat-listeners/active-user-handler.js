...
exports.addOnlineUser = async (username) => {
    ...
    try {
        let twitcherbotUser = await userDatabase.getTwitchUserByUsername(username);
        ...
        if (twitcherbotUser == null) {
            ...
            const userDetails = {
                id: twitcherbotUser._id,
                username: twitcherbotUser.username,
                displayName: twitcherbotUser.displayName,
                twitchRoles: twitcherbotUser.twitchRoles,
                profilePicUrl: twitcherbotUser.profilePicUrl
            };
