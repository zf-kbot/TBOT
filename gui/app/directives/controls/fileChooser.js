    ...
    angular
        ...
        .component("fileChooser", {
            ...
            <div style="display: flex;flex-direction: row;align-items: center;">
                ...
                <span ng-hide="$ctrl.hideManualEdit" class="clickable" style="margin-left: 10px" ng-click="$ctrl.editFilePath()" uib-tooltip="Edit filepath manually" tooltip-append-to-body="true"><i class="fa fa-edit"></i></span>
                <span ng-if="$ctrl.model != null && $ctrl.model !== ''" class="clickable" style="margin-left: 10px" ng-click="$ctrl.model = null"><i class="fa fa-times-circle"></i></span>
            </div>
            `,
