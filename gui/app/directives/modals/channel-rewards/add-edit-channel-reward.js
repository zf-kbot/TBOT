            ...
            template: `
                ...
                <div class="modal-body" style="padding-top: 15px;">
                    <div ng-if="!$ctrl.reward.manageable" style="display: flex; flex-direction: column;">
                        ...
                        <p class="help-block" style="text-align: center;">This reward was created outside of Twitchbot so it's settings cannot be changed here. You can however still create effects for it. If you want to update settings for this Reward, you can do so on Twitch.</p>
                    </div>
