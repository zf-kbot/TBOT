...
exports.setupCommonListeners = () => {
    ...
    frontendCommunicator.on("highlight-message", data => {
        ...
        eventsManager.triggerEvent("twitcherbot", "highlight-message", data);
    });

    frontendCommunicator.on("click-twitch-login", data => {
        const windowManagement = require("../app-management/electron/window-management");
        windowManagement.createTwitchLoginScreen(data.url);
    });

    frontendCommunicator.on("pop-chat-box", () => {
        const windowManagement = require("../app-management/electron/window-management");
        windowManagement.createChatBoxWindow();
    });
    ...
    // Opens the twitchbotbackup folder
