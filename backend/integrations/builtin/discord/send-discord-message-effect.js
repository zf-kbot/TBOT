                    ...
                    <div ng-show="effect.includeEmbed">
                        ...
                        <div ng-show="effect.embedType === 'custom'">
                            ...
                            <div style="margin-top:10px;">
                                <twitcherbot-input input-title="Title" model="effect.customEmbed.title"></twitcherbot-input>
                            </div>
                            
                            <div style="margin-top:10px;">
                                <twitcherbot-input input-title="Content" model="effect.customEmbed.description"></twitcherbot-input>
                            </div>

                            <div style="margin-top:10px;">
                                <twitcherbot-input input-title="Author Name" model="effect.customEmbed.authorName"></twitcherbot-input>
                            </div>

                            <div style="margin-top:10px;">
                                <twitcherbot-input input-title="Author Icon URL" model="effect.customEmbed.authorIconUrl"></twitcherbot-input>
                            </div>
