...
exports.handleSquirrelEvents = () => {
    if (process.platform === "win32") {
        ...
        new ProgId({
            description: 'Twitchbot Setup',
            progExt: "twitcherbotsetup",
            squirrel: true,
            icon: './resources/twitcherbot-setup-file-icon.ico',
            extensions: ['twitcherbotsetup'],
            shell: [
                new ShellOption({
                    verb: 'import',
                    action: 'Import into Twitchbot',
                    selected: true,
