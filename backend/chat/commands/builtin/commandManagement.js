...
const commandManagement = {
    definition: {
        id: "twitcherbot:commandmanagement",
    ...
    onTriggerEvent: event => {
        return new Promise(async (resolve) => {
            ...
            case "response": {
                ...
                let chatEffectsCount = command.effects ? command.effects.list.filter(e => e.type === "twitcherbot:chat").length : 0;
                ...
                if (chatEffectsCount === 1) {
                    let chatEffect = command.effects.list.find(e => e.type === "twitcherbot:chat");
