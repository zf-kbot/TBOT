    ...
    <div ng-show="effect.videoType">
        ...
        <eos-container>
            <div class="effect-info alert alert-warning">
                This effect requires the Twitchbot overlay to be loaded in your broadcasting software. <a href ng-click="showOverlayInfoModal(effect.overlayInstance)" style="text-decoration:underline">Learn more</a>
                <br>
    ...
    overlayExtension: {
        ...
        event: {
            ...
            onOverlayEvent: event => {
                ...
                let filepathNew = `http://${window.location.hostname}:7473/resource/${token}`;
