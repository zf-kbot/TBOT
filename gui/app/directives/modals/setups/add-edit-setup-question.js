        ...
        .component("addOrEditSetupQuestion", {
            template: `
                ...
                <div class="modal-body">
                    ...
                    <h3>Replace Token <tooltip text="'Twitchbot will replace any instances of this token with the users answer to this question. A token can be anything but you might want to use uncommon characters. Ie %WagerAmount%'"/></h3>
