...
const effectDefinitions = [
    ...
    {
        id: "GAME_CONTROL",
        v5Id: "twitcherbot:controlemulation",
        name: "Game Control",
        triggers: ALL_TRIGGERS,
        dependencies: [],
    ...
    {
        id: "EFFECT_GROUP",
        v5Id: "twitcherbot:run-effect-list",
        name: "Effect Group",
        triggers: ALL_TRIGGERS,
        dependencies: [],
        description:
    ...
    },
    {
        ...
        v5Id: "twitcherbot:toggleconnection",
        name: "Toggle Connection",
        triggers: ALL_TRIGGERS,
        dependencies: [],
        description: "Toggles Twitchbot's connection to Mixer services"
    },
    {
        id: "SHOW_TEXT",
        v5Id: "twitcherbot:showtext",
        name: "Show Text",
        triggers: ALL_TRIGGERS,
        dependencies: [Dependency.OVERLAY],
