    ...
    angular.module("twitcherbotApp").component("startupScriptsListModal", {
        template: `
            ...
            <div class="modal-body">
                ...
                <div class="muted" style="margin-top: 10px; font-size: 11px;" ng-show="$ctrl.sss.getStartupScripts().length > 0"><b>Note</b>: Newly added/updated scripts wont take affect until Twitchbot is restarted.</div>
            </div>
