...
(function () {
    angular.module("twitcherbotApp").component("subcommandRow", {
        bindings: {
            subcommand: "=",
            fullyEditable: "<",
            cmdTrigger: "@",
        ...
        <div uib-collapse="hidePanel" class="sys-command-expanded">
          <div style="padding: 15px 20px 10px 20px;">
            ...
            <div class="controls-fb-inline" style="padding-bottom:10px">
              ...
              <label class="control-fb control--checkbox">Auto Delete Trigger <tooltip text="'Have Twitchbot automatically delete the message that triggers this subcommand to keep chat cleaner.'"></tooltip>
